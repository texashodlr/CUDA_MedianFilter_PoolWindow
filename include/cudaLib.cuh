...
#define CUDA_LIB_H
	 ...
	 * @return int 
	 */
	extern __global__ void medianFilter_gpu (uint8_t * inPixels, uint8_t * outPixels,
		 int height, int width, int channels, int filterH, int filterW);

	extern __global__ void medianFilter_gpu2 (uint8_t* inPixels, uint8_t* outPixels,
		int height, int width, int channels, int filterH, int filterW);

	extern __global__ void medianFilter_gpu3(uint8_t* inPixels, uint8_t* outPixels,
		int height, int width, int channels, int filterH, int filterW);

	extern __global__ void medianFilter_gpu4(uint8_t* inPixels, uint8_t* outPixels,
		int height, int width, int channels, int filterH, int filterW);
	...
	extern __global__ void poolLayer_gpu_shared(float* input, TensorShape inShape,
		float* output, TensorShape outShape, PoolLayerArgs args);
